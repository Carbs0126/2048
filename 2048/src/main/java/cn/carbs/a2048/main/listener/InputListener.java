package cn.carbs.a2048.main.listener;
    ...
    public boolean onTouch(View view, MotionEvent event) {
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                //"Menu" inputs
                if (!hasMoved) {
                    Log.d("wang","ACTION_UP 1");
                    if (iconPressed(mView.sXNewGame, mView.sYIcons)) {
                        Log.d("wang","ACTION_UP 2");
                        if (!mView.game.gameLost()) {
                            new AlertDialog.Builder(mView.getContext())
                                    ...
                                    .show();
                            Log.d("wang","ACTION_UP 3");
                        } else {
                            Log.d("wang","ACTION_UP 4");
                            mView.game.newGame();
                        }

                    } else if (iconPressed(mView.sXUndo, mView.sYIcons)) {
                        mView.game.revertUndoState();
                        Log.d("wang","ACTION_UP 5");
